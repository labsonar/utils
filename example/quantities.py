...
print(f"b4-(b4-b3){type(b4-(b4-b3))}: ", b4-(b4-b3))
print(f"(b4-b3)+b3{type((b4-b3)+b3)}: ", (b4-b3)+b3)
print(f"(b4-b3)-b4{type((b4-b3)-b4)}: ", (b4-b3)-b4)
print("2*b3: ", 2*b3)
print("(b3*4)/2: ", (b3*4)/2)
print(f"2*(b4-b3){type(2*(b4-b3))}: ", 2*(b4-b3))

s1 = lps_qty.Speed.kt(10)
s2 = lps_qty.Speed.kt(0)
...
print("((s1**2) + (s2**2)): ", ((s1**2) + (s2**2)))
print("((s2**2) + (s2**2)): ", ((s2**2) + (s2**2)))
print("((s2**2) + (s1**2)): ", ((s2**2) + (s1**2)))
print("((s1**2) + (s2**2))**0.5: ", ((s1**2) + (s2**2))**0.5)
print("s2**2**0.5: ", (s2**2)**0.5)
